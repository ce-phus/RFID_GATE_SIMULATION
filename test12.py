...
total_price_label = tk.Label(root, text="Total Price: $0.00",font=("Arial", 25))
item_info_label = tk.Label(root, text="Items in Trolley:", font=("Arial", 25))
item_listbox = tk.Listbox(root, width=50, height=30)
...
pay_button = tk.Button(root, text="Make Payment",font=("Arial", 25), command=make_payment, state=tk.DISABLED)
pay_button.pack()
